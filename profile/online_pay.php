...
if(!isset($error)){
                    ...
                    $app_token = $a_token;
                        ...
                        if($result["status"] == 1000){
                            ...
                            $txt = $result['data']["ipg_transaction_id"]."|".date("Y-m-d h:i:sa")."|".$_SESSION['reid']."|".$result["status"]."|".$result["message"];
                            fwrite($myfile, "\n". $txt);
                            fclose($myfile); 
                         ...
                         //selected_data();
                          ...
                          $error = "ඔබේ මුදල් ගෙවීම අසාර්ථකයි.! Getway Code" . $result["status"];
